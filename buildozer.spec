...
# (list) Source files to include (let empty to include all the files in your directory)
...
#android.add_activities = com.example.Thing
...
# (bool) enables generating a 64-bit version of the app
#android.enable_androidx = False

# (bool) use the new android toolchain (gradle)
# this value will be set automatically if one of the deployment targets is jelly bean (5) or higher
#android.gradle = 3
